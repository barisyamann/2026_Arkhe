...
- Tarih: 2026-09-14T03:16:39+03:00
...
| Gecikme (medyan / p95 / max) | 8.02 / 22.38 / 23.39 ms |
| Olculen hizlanma (yazilim / donanim) | 176.7x |
...
|---|---|---|
| silence_zeros | PASS | cikti=no, gecikme=23.2 ms, sonraki gecerli cerceve yanitladi |
| silence_dither | PASS | cikti=no, gecikme=22.7 ms, sonraki gecerli cerceve yanitladi |
| saturate_max | PASS | cikti=unknown, gecikme=8.0 ms, sonraki gecerli cerceve yanitladi |
| saturate_min | PASS | cikti=silence, gecikme=23.5 ms, sonraki gecerli cerceve yanitladi |
| alternating | PASS | cikti=silence, gecikme=7.6 ms, sonraki gecerli cerceve yanitladi |
| back_to_back | FAIL | araliksiz 5 cerceveden 4 tanesi yanitlandi |
| truncated_frame | PASS | kesik cerceve sonrasi kurtarma basarili (cikti=unknown) |
...
| determinism | PASS | 10 tekrarda 1 farkli sonuc; gecikme jitter=14.78 ms |
