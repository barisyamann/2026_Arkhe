...
CATALOG = dict.fromkeys([
    ...
    'I2C_NO_SLAVE_DONE',
    # --- Demo C: ESP32 ile gercek I2C veri alisverisi (14 Eylul 2026) ---
    #   Demo B'de I2C yalnizca "harici slave yok, islem tamamlandi"
    #   seviyesindeydi. Bu uc denetim ESP32'nin (adres 0x42) karttan
    #   gelen bayti alip TERSINI dondurdugunu dogrular; yani gercek
    #   cift yonlu veri alisverisi ve dolayli olarak ACK kanitlanir.
    'I2C_ESP_TX_DONE', 'I2C_ESP_RX_DONE', 'I2C_ESP_VERI_DOGRU'], 1)
...
def main():
    ...
    report = {'passed': False, 'physical_board_test': True, 'port': args.port,
              ...
              'manual_gpio': 'NOT_RUN', 'limits': [
                  'I2C: ESP32 (adres 0x42) ile gercek yaz-oku dogrulandi; flash programlama/silme komutlari ve coklu-slave hakemligi kapsam disi',
    ...
    if report['passed']:
        print(f'GECTI: 2 x {sum(CATALOG.values())} oztest kontrolu, {len(report["inferences"])} NPU sonucu, UART bayt testleri. GPIO: {report["manual_gpio"]}')
