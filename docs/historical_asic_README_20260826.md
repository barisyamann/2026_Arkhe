...
| Metrik | Deger | Not |
|---|---|---|
| **Setup WNS (nom_tt)** | **+1.1858 ns** | 53.1 MHz hedef frekans saglandi (0 ihlal) |
| **Setup TNS (nom_tt)** | **0.0000 ns** | 0 setup ihlali |
| **Hold WNS (nom_tt)** | **+0.1871 ns** | 0 hold ihlali |
| **Hold TNS (nom_tt)** | **0.0000 ns** | 0 hold ihlali |
| **Hold WNS (max_ff)** | **-0.0825 ns** | Yalnizca 20 reg-to-reg ihlal (687'den %97 azaldi) |
| **Worst-Case ss WNS** | **-10.2468 ns** | CV32E40P 3. parti yolu (35.7 MHz endustriyel derating) |

## Fiziksel signoff

| Kontrol | Sonuc | Durum |
|---|---|---|
| **Magic DRC** | 7658 (nwell.4 tap soyutlama) | KLayout GDS ve %87.3 tap yogunlugu ile dogrulandi |
| **KLayout DRC** | **0 Hata** | GDSII uretim kurallari %100 temiz |
| **Netgen LVS** | **Passed** | 89.669 ag birebir eslesti, 0 uyumsuzluk |
| **Anten ihlali** | **0 (Sifir)** | 0 net / 0 pin ihlali |
| **XOR farki** | **0 Fark** | Magic ve KLayout GDS'leri birebir ayni |
| **Baglantisiz pin** | **0 Hata** | 883.532 via ve 90.000 ag baglandi |
| **PDN ihlali** | **0 Ihlal** | Guc aginda 0 ihlal |
