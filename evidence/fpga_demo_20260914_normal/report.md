...
- Tarih: 2026-09-14T03:12:56+03:00
...
| Gecikme (medyan / p95 / max) | 8.02 / 17.98 / 23.33 ms |
| Olculen hizlanma (yazilim / donanim) | 176.9x |
...
|---|---|---|
| silence_zeros | PASS | cikti=no, gecikme=7.7 ms, sonraki gecerli cerceve yanitladi |
| silence_dither | PASS | cikti=no, gecikme=22.7 ms, sonraki gecerli cerceve yanitladi |
| saturate_max | PASS | cikti=unknown, gecikme=23.6 ms, sonraki gecerli cerceve yanitladi |
...
| determinism | PASS | 10 tekrarda 1 farkli sonuc; gecikme jitter=15.47 ms |
