...
- Tarih: 2026-09-13T23:14:19+03:00
...
| Gecikme (medyan / p95 / max) | 7.87 / 11.56 / 21.30 ms |
| Olculen hizlanma (yazilim / donanim) | 180.1x |
...
|---|---|---|
| silence_zeros | PASS | cikti=no, gecikme=6.9 ms, sonraki gecerli cerceve yanitladi |
| silence_dither | PASS | cikti=no, gecikme=6.9 ms, sonraki gecerli cerceve yanitladi |
| saturate_max | PASS | cikti=unknown, gecikme=8.1 ms, sonraki gecerli cerceve yanitladi |
| saturate_min | PASS | cikti=silence, gecikme=7.5 ms, sonraki gecerli cerceve yanitladi |
| alternating | PASS | cikti=silence, gecikme=9.5 ms, sonraki gecerli cerceve yanitladi |
...
| determinism | PASS | 10 tekrarda 1 farkli sonuc; gecikme jitter=1.34 ms |
