...
REM
REM Generated by Vivado on Fri Jun 12 10:50:52 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_soc_top_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_soc_top_vlog.prj -log xvlog.log
